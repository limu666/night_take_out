...
public class AddressBookController {
    ...
    /*修改地址信息*/
    @PutMapping
    public R<String> putSave(@RequestBody AddressBook addressBook){
        log.info("信息为：{}",addressBook);
        addressBookService.updateById(addressBook);
    ...
    //删除地址通过id
    @DeleteMapping
    public R<String> delById(@RequestParam Long ids){
        log.info("id为：{}",ids);
        AddressBook book = addressBookService.getById(ids);
        if(book == null){
            return R.error("信息错误...");
        }else {
